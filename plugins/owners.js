...
let faketext = {
  ...
  message: {
    conversation: 'السودان حر مهما كان الثمن ❤️'
  }
};
...
await conn.sendContact(m.chat, [[`249128749239` + `@s.whatsapp.net`, wm]], vn, {
 contextInfo: { 
...
isForwarded: false, 
 ...
 title: 'ᵐᵒʰᵃᵐᵐᵉᵈ ᵃᵈᵉˡ', 
 body: '𝕄𝕆ℍ𝔸𝕄𝕄𝔼𝔻 𝔸𝔻𝔼𝕃', 
 sourceUrl: 'https://chat.whatsapp.com/HEymhaMK6EfD4MRWj00juf',
 thumbnail: vn2,
 thumbnailUrl: vn2, 
 mediaType: 1,
